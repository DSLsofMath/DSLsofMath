...
+ Prel. A2 groups announced: new teams to the "discuss and compare" learning outcome
  + I will fix them on Thursday.
+ Mid-course eval. meeting was today (2026-02-10, 12:20, EDIT-6128)
  | Name                | Program |
  |---------------------+---------|
  | Fabian Hedström     | TKDAT   |
  | Viktor Schewenius   | TKDAT   |
  | Nova Alldén         | TKDAT   |
  | Alexander Ranefjärd | TKTEM   |
  |---------------------+---------|
...
** Homomorphism: H2(h,(+),(*)) = ∀ x, y. h(x+y) == h x * h y
...
* L4.1c: Extra lecture (Live-coding) Haskell type classes
...
TODO: eva2  :: (a->a->a)->(a->a->a)->(I->a)->IE->a
TODO: evaIE :: IntExt a => IE -> a
TODO: |class IntExp|
TODO: instance I
